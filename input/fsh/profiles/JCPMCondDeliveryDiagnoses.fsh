Profile: JCPMCondDeliveryDiagnoses
Parent: ILCoreCondition
Id: jcpm-cond-delivery-diags
Title: "JCPM Condition Delivery Diags"
Description: "Delivery conditions / problems / diagnoses"
* ^language = #he-IL
...
* ^url = "http://fhir.outburn.co.il/StructureDefinition/jcpm-cond-delivery-diagnoses"
* ^version = "0.1.0"
* ^status = #draft
* ^date = "2022-01-30"
...
* . ^short = "JCPM Condition-DeliveryDiagnoses profile"
...
* category[jcpm-resource-category].coding 1..
  ...
  * code 1..
  * code from DeliveryDiagnoses (required)
* code from DeliveryDiagnoses (extensible)
  * coding 1..1
    * system 1..
